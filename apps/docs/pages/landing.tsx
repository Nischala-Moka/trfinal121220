    ...
    <>
      ...
      <div className={styles.mainContent}>
        ...
        <p className={styles.para}>
          The Libraries can prevent waterfalls by offering a more centralized
          way to do data fetching. For example, Relay solves this problem by
          moving the information about the data a component needs to statically
          ...
          combining our data fetching methods are:
        </p>
        <br />
